 ...
 * @generated
 */
public class IlmioLocalServiceClp implements IlmioLocalService {
    ...
    public IlmioLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "findByAineistoIlmioTyyppiKuvausPaikka";
        ...
        _methodName20 = "findIlmioPaikkaByRyhmaId";

        _methodParameterTypes20 = new String[] { "int[][]" };

        _methodName21 = "findByRyhmaId";
    ...
    public fi.csc.avaa.kotus.kielikartastot.db.model.Ilmio addIlmio(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(ilmio) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.kotus.kielikartastot.db.model.Ilmio) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.kotus.kielikartastot.db.model.Ilmio createIlmio(int ilmio_id) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { ilmio_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.kotus.kielikartastot.db.model.Ilmio deleteIlmio(int ilmio_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { ilmio_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.kotus.kielikartastot.db.model.Ilmio fetchIlmio(int ilmio_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { ilmio_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.kotus.kielikartastot.db.model.Ilmio getIlmio(int ilmio_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { ilmio_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.kotus.kielikartastot.db.model.Ilmio> getIlmios(
        ...
        return (java.util.List<fi.csc.avaa.kotus.kielikartastot.db.model.Ilmio>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.avaa.kotus.kielikartastot.db.model.Ilmio> findByAineistoIlmioTyyppiKuvausPaikka(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    ClpSerializer.translateInput(ilmioVal),
                        
                    ClpSerializer.translateInput(tyyppiVal),
                        
                    ClpSerializer.translateInput(kuvausVal),
                        
                    ClpSerializer.translateInput(paikkaVal)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
