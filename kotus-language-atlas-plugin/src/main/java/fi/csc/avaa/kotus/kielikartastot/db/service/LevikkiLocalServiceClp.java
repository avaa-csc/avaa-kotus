 ...
 * @generated
 */
public class LevikkiLocalServiceClp implements LevikkiLocalService {
    ...
    public LevikkiLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fi.csc.avaa.kotus.kielikartastot.db.model.Levikki addLevikki(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(levikki) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.kotus.kielikartastot.db.model.Levikki) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.kotus.kielikartastot.db.model.Levikki createLevikki(int levikki_id) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { levikki_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.kotus.kielikartastot.db.model.Levikki deleteLevikki(int levikki_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { levikki_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.kotus.kielikartastot.db.model.Levikki fetchLevikki(int levikki_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { levikki_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.kotus.kielikartastot.db.model.Levikki getLevikki(int levikki_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { levikki_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.kotus.kielikartastot.db.model.Levikki> getLevikkis(
        ...
        return (java.util.List<fi.csc.avaa.kotus.kielikartastot.db.model.Levikki>) ClpSerializer.translateOutput(returnObj);
    }
