...
import fi.csc.avaa.kotus.kielikartastot.db.service.AineistoService;
...
/**
 * Provides the base implementation for the aineisto remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.kotus.kielikartastot.db.service.impl.AineistoServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class AineistoServiceBaseImpl extends BaseServiceImpl
    implements AineistoService, IdentifiableBean {
    ...
    private AineistoServiceClpInvoker _clpInvoker = new AineistoServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.kotus.kielikartastot.db.service.AineistoServiceUtil} to access the aineisto remote service.
     */
