...
import fi.csc.avaa.kotus.kielikartastot.db.service.IlmioService;
...
/**
 * Provides the base implementation for the ilmio remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.kotus.kielikartastot.db.service.impl.IlmioServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class IlmioServiceBaseImpl extends BaseServiceImpl
    implements IlmioService, IdentifiableBean {
    ...
    private IlmioServiceClpInvoker _clpInvoker = new IlmioServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.kotus.kielikartastot.db.service.IlmioServiceUtil} to access the ilmio remote service.
     */
