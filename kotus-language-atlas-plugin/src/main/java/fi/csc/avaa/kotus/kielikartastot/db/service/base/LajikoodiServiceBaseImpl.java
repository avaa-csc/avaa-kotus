...
import fi.csc.avaa.kotus.kielikartastot.db.service.LajikoodiService;
...
/**
 * Provides the base implementation for the lajikoodi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.kotus.kielikartastot.db.service.impl.LajikoodiServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class LajikoodiServiceBaseImpl extends BaseServiceImpl
    implements LajikoodiService, IdentifiableBean {
    ...
    private LajikoodiServiceClpInvoker _clpInvoker = new LajikoodiServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.kotus.kielikartastot.db.service.LajikoodiServiceUtil} to access the lajikoodi remote service.
     */
