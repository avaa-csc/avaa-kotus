...
import fi.csc.avaa.kotus.kielikartastot.db.service.LevikkiService;
...
/**
 * Provides the base implementation for the levikki remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.kotus.kielikartastot.db.service.impl.LevikkiServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class LevikkiServiceBaseImpl extends BaseServiceImpl
    implements LevikkiService, IdentifiableBean {
    ...
    private LevikkiServiceClpInvoker _clpInvoker = new LevikkiServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.kotus.kielikartastot.db.service.LevikkiServiceUtil} to access the levikki remote service.
     */
