...
import fi.csc.avaa.kotus.kielikartastot.db.service.PaikkaService;
...
/**
 * Provides the base implementation for the paikka remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.kotus.kielikartastot.db.service.impl.PaikkaServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class PaikkaServiceBaseImpl extends BaseServiceImpl
    implements PaikkaService, IdentifiableBean {
    ...
    private PaikkaServiceClpInvoker _clpInvoker = new PaikkaServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.kotus.kielikartastot.db.service.PaikkaServiceUtil} to access the paikka remote service.
     */
