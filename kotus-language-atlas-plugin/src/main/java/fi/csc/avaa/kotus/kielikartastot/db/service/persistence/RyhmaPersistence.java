...
/**
 * The persistence interface for the ryhma service.
 *
 * <p>
 ...
 * @generated
 */
public interface RyhmaPersistence extends BasePersistence<Ryhma> {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link RyhmaUtil} to access the ryhma persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
     */
    ...
    */
    public void cacheResult(fi.csc.avaa.kotus.kielikartastot.db.model.Ryhma ryhma);
    ...
    */
    public fi.csc.avaa.kotus.kielikartastot.db.model.Ryhma create(int ryhma_id);
    ...
    */
    public fi.csc.avaa.kotus.kielikartastot.db.model.Ryhma remove(int ryhma_id)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.avaa.kotus.kielikartastot.db.NoSuchRyhmaException;

    public fi.csc.avaa.kotus.kielikartastot.db.model.Ryhma updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.avaa.kotus.kielikartastot.db.model.Ryhma findByPrimaryKey(int ryhma_id)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.avaa.kotus.kielikartastot.db.NoSuchRyhmaException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.avaa.kotus.kielikartastot.db.model.Ryhma fetchByPrimaryKey(int ryhma_id)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<fi.csc.avaa.kotus.kielikartastot.db.model.Ryhma> findAll()
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<fi.csc.avaa.kotus.kielikartastot.db.model.Ryhma> findAll(int start,
